  ...
  * =========================== */
  ...
  $.fn.filmstrip = function (option) {
    return this.each(function () {
      ...
      if (!data) $this.data('filmstrip', (data = new Filmstrip(this, options)))
      if (typeof option == 'number') data.to(option)
      else if (options.filmstrip == 'selector') data.selector(options.index);
      else if (typeof option == 'string' || (option = options.filmstrip)) data[option]()
